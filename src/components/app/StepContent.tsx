...
export const StepContent: React.FC<StepContentProps> = ({
  lines, currentColor, onUpdateLineText, onAddLine, onRemoveLine, onMergeLinesUp, onPaste, onColorChange,
}) => {
  return (
    <div className="h-full flex flex-col bg-background">
      ...
      <motion.button
        ...
        onClick={() => onAddLine()}
        className="fixed bottom-24 right-5 z-30 w-14 h-14 rounded-2xl bg-primary text-primary-foreground shadow-xl shadow-primary/25 flex items-center justify-center active:shadow-lg"
      >
