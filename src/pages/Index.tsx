  ...
  return <div className={cn("min-h-screen overflow-x-hidden transition-colors duration-500", moodStyles.background)}>
      ...
      damping: 30
        ...
        <div className="container mx-auto px-3 sm:px-4 lg:px-6 h-full flex items-center justify-between overflow-hidden">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 flex-shrink-0">
            ...
            {!premium.isPremium && <motion.div whileTap={{
            scale: 0.95
          }}>
            ...
            {user ? <HeaderProfileButton /> : <motion.div whileTap={{
            scale: 0.95
          }}>
      ...
      <div className="fixed bottom-6 right-4 z-30 flex flex-col gap-3 lg:hidden">
        ...
        scale: 1.05
          ...
          <AnimatedButton variant="outline" size="icon" onClick={() => {
        ...
        }} className="h-14 w-14 rounded-2xl shadow-soft-lg glass-card border-border/50" title={premium.isPremium ? 'Dictation' : 'Premium'}>
        ...
        <div className="hidden lg:grid lg:grid-cols-12 gap-5">
          ...
          delay: 0.2
            ...
            <div className="rounded-2xl border border-border/50 min-h-[calc(100vh-10rem)] overflow-hidden shadow-2xl">
              <AnimatePresence mode="wait" custom={pageDirection}>
                ...
                stiffness: 300,
                damping: 30
              }} className="h-full" drag="x" dragConstraints={{
                left: 0,
                right: 0
              }} dragElastic={0.2} onDragEnd={(_, info) => {
                if (info.offset.x > 80 || info.velocity.x > 400) {
          ...
          delay: 0.3
            ...
            <div className="sticky top-36">
              ...
              {/* Settings Toggle */}
              <Button variant="ghost" size="sm" onClick={() => setShowControls(!showControls)} className="w-full mt-3 gap-2 rounded-xl">
